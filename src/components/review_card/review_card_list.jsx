    ...
    constructor(){
        ...
        this.state = {
            cards: [{
                ...
                review_text: "Excelente producto final, nos gustó mucho la base de datos que nos hicieron de nuestro personal activo y dado de baja y la página web de la empresa, gracias.", 
                review_stars: <Star5/>, 
                id: "card1"
            },
            {
                ...
                review_text: "Estoy muy feliz con las plantillas de Excel que realizaron, ahora puedo calcular la nómina de mi personal en menos de 5 minutos y la utilidad de mi empresa de forma sencilla, recomendados.", 
                review_stars: <Star4/>, 
                id: "card2"
            },
            {
                ...
                review_text: "Me encantó la aplicación, ahora gracias a esta app puedo registrar las horas de entradas y salidas de mis empleados, gracias, muy profesionales.", 
                review_stars: <Star5/>, 
                id: "card3"
            }
            ]
