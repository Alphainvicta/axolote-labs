        ...
        <div className="contact_container">
            <div className="side_a">
                ...
                <div className="mail">
                    <Mail/>
                    <p>
                        AxolotLabsContacto@gmail.com
                    </p>
                </div>
            </div>
            <div className="side_b">
                <Input input_type="text" input_icon={<User/>} input_text="Nombre completo"/>
                <Input input_type="email" input_icon={<Purple_mail/>} input_text="Email"/>
